...
// MFC_USB_BRR.cpp: define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CMFCUSBBRRApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CMFCUSBBRRApp

CMFCUSBBRRApp::CMFCUSBBRRApp()
{
...
// Único objeto CMFCUSBBRRApp

CMFCUSBBRRApp theApp;


// Inicialización de CMFCUSBBRRApp

BOOL CMFCUSBBRRApp::InitInstance()
{
